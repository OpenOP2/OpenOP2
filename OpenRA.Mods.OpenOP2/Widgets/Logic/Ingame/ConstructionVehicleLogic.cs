...
namespace OpenRA.Mods.OpenOP2.Widgets.Logic
{
	...
	public class ConstructionVehicleLogic : ChromeLogic
	{
		readonly ConstructionVehiclePaletteWidget palette;

		[ObjectCreator.UseCtor]
		public ConstructionVehicleLogic(Widget widget)
		{
			palette = widget.Get<ConstructionVehiclePaletteWidget>("BUILD_SELECT_PALETTE4");
