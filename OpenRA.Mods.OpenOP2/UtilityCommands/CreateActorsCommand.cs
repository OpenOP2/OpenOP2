...
namespace OpenRA.Mods.OpenOP2.UtilityCommands
{
	class CreateActorsCommand : IUtilityCommand
	{
		...
		const string RulesOutputFilename = "..\\mods\\openop2\\rules\\rules-generated.yaml";
		const string RulesExampleOutputFilename = "..\\mods\\openop2\\rules\\rules-example.yaml";

		string IUtilityCommand.Name => "--create-actors";

		readonly bool onlyIdleSequence = false;

		ActorRule[] actorRules;
